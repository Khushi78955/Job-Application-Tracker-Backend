...
import { createApplicationSchema, updateApplicationSchema, applicationQuerySchema } from "../validators/application.validator.js";
...
router.get("/", validate(applicationQuerySchema, "query"), getAll)
